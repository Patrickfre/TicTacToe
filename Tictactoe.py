...
btn1=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn1))
btn2=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn2))
btn3=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn3))
btn4=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn4))
btn5=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn5))
btn6=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn6))
btn7=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn7))
btn8=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn8))
btn9=Button(Logs,text="",width=5,height=2,font=("Helvetica",24),bd=4,fg="White",bg="turquoise",command=lambda:btnClick(btn9))
